...
useEffect(async () => {
  ...
  await fetch("http://192.168.1.15:3001/reservation/getByS/"+data.data.station._id
)
  .then((res) => res.json())
  .then((resJSON) => {
...
/*const Supprimerr = async (_id) => {
 ...
 , {
  ...
  const Approuver = async (_id) => {
    ...
    fetch("http://192.168.1.15:3001/reservation/updateEtat/"+_id
 , {
        method: 'PUT',
...
navigation.navigate('Dashboard')
 ...
 const Approuver1 = async (_id) => {
  ...
  fetch("http://192.168.1.15:3001/reservation/updateEtatRefuse/"+_id
, {
      method: 'PUT',
